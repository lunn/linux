...
enum {
	...
	ETHA_EVENT_CABLE_TEST,			/* nest - ETHA_CABLE_TEST_* */
...
enum {
	ETHA_CABLE_TEST_UNSPEC,
	ETHA_CABLE_TEST_DEV,			/* nest - ETHA_DEV_* */

	__ETHA_CABLE_TEST_CNT,
	ETHA_CABLE_TEST_MAX = (__ETHA_CABLE_TEST_CNT - 1)
};
