...
/* total size of ETHTOOL_A_*_DEV nested attribute; this is an upper estimate so
 * that we do not need to hold RTNL longer than necessary to prevent rename
 * between estimating the size and composing the message
 */
