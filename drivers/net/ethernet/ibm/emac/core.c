...
static void emac_adjust_link(struct net_device *ndev)
{
	...
	dev->phy.advertising =
		ethtool_convert_link_mode_to_legacy_u32(phy->advertising);
}
				    ...
				    struct phy_device *phy_dev)
{
	...
	phy_dev->advertising =
		ethtool_convert_legacy_u32_to_link_mode(phy->advertising);
			       ...
			       struct device_node *phy_handle)
{
	...
	dev->phy.features =
		ethtool_convert_link_mode_to_legacy_u32(dev->phy_dev->supported);
