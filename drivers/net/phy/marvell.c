...
#define MII_88E6390_MISC_TEST_SAMPEL_MASK	(0x3 << 14)
...
static int m88e6390_get_temp(struct phy_device *phydev, long *temp)
{
	...
	*temp = 0;
	...
	/* Enable temperature sensor */
	ret = phy_read(phydev, MII_88E6390_MISC_TEST);
	if (ret < 0)
		goto error;

	ret = ret & ~MII_88E6390_MISC_TEST_SAMPEL_MASK;
	ret |= MII_88E6390_MISC_TEST_SAMPLE_ENABLE |
		MII_88E6390_MISC_TEST_SAMPLE_1S;

	ret = phy_write(phydev, MII_88E6390_MISC_TEST, ret);
	if (ret < 0)
		goto error;
	...
	for (i = 0; i < MII_88E6390_TEMP_SENSOR_SAMPLES; i++) {
		ret = phy_read(phydev, MII_88E6390_TEMP_SENSOR);
		if (ret < 0)
			goto error;
