...
int mv88e6xxx_g2_scratch_gpio_set_ext_smi(struct mv88e6xxx_chip *chip,
					  bool external)
{
	int smi_reg = MV88E6352_G2_SCRATCH_MISC_CFG; /* TODO not all models */
	int err;
	u8 val;
...
{
	int offset = (pin / 8);
	int reg = MV88E6352_G2_SCRATCH_GPIO_DATA0 + offset;
	u8 mask = (1 << (pin & 0x7));
