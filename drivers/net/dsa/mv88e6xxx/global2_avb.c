...
static int mv88e6352_g2_avb_port_ptp_read(struct mv88e6xxx_chip *chip, int port,
...
static int mv88e6352_g2_avb_port_ptp_write(struct mv88e6xxx_chip *chip, int port,
					   int addr, u16 data)
{
...
static int mv88e6390_g2_avb_port_ptp_read(struct mv88e6xxx_chip *chip, int port,
					  int addr, u16 *data, int len)
{
...
static int mv88e6390_g2_avb_port_ptp_write(struct mv88e6xxx_chip *chip, int port,
					   int addr, u16 data)
{
