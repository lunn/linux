...
struct mv88e6xxx_gpio_ops {
	...
	int (*get_data)(struct mv88e6xxx_chip *chip, unsigned pin);
	int (*set_data)(struct mv88e6xxx_chip *chip, unsigned pin, int value);

	/* get/set GPIO direction */
	int (*get_dir)(struct mv88e6xxx_chip *chip, unsigned pin);
	int (*set_dir)(struct mv88e6xxx_chip *chip, unsigned pin, bool input);

	/* get/set GPIO pin control */
	int (*get_pctl)(struct mv88e6xxx_chip *chip, unsigned pin, int *func);
	int (*set_pctl)(struct mv88e6xxx_chip *chip, unsigned pin, int func);
};
